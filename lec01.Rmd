...
* You will do this practice, this once, using the terminal
* If stuff gets messed up later, we can clean it up with the terminal
...
* Go to https://github.com/STATS-432Sp2020/class-roster
