...
2. Don't write anything more than once. This has three corollaries:
    ...
    2. Don't use _magic numbers_. Define all constants at the top of the script.
    3. Write functions.
...
unless you've checked those assumptions somehow; see Chapter 2 of the notes,
...
```{r test, cache=TRUE, echo=TRUE, results='hide'}
#
library(np)
...
```{r, fig.align='center',fig.height=12,fig.width=10,cache=TRUE,autodep=TRUE}
